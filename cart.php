        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <?php echo"<a href='contact.php?user=".$user['id']."' class='btn btn-info btn-sm btn-flat'><i class='fa fa-paper-plane'></i> Message</a>";?>
            ...
            <div class="box-footer ">
              <form method="POST" action="move.php">
                <?php
                  ...
                  $pdo->close();
                ?>
                <button type="submit" class="btn btn-flat btn-large pull-right btn-success" name="add">Process Order  <i class="fa fa-exchange"></i></button>
              </form>
              <h5 class="text-info"><strong>Email:    <span class="text-success"><?php echo $user['email'];?></span></strong></h5>
              <h5 class="text-info text-center"><strong>Contact:  <span class="text-success"><?php echo $user['contact_info'];?></span></strong></h5>      
            </div>
          </div>
        </div>
      </div>
