...
<head>
    ...
    <meta name="keywords" content="Manu Tiwari, Ghaziabad,Uttar Pradesh, India">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <meta name="theme-color" content="#00A65A">
    <title>Manu Bookshop | Home</title>
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <h1 class="header-logo" style="color: black;"><b style="color:tomato;">Manu</b>Bookshop</h1>
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><a href="mailto:info@manubookshop.co.ke"><i class="fa fa-envelope"></i> info@manubookshop.co.ke</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><a style="color: #ffffff;" href="mailto:info@manubookshop.co.ke"><i class="fa fa-envelope"></i> info@manubookshop.co.ke</a></li>
                                <li>Proud To Be Your Education partner</li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="carousel-item active" style="background-color: #f3f6fa;">
                                <div class="row">
                                    <div class="hero__text text-center col-md-5" style="padding-top: 5%;">
                                        ...
                                        <h2>Indian Booksellers <br/> Association</h2>
                                        <p style="color:red;">We Are Manubookshop</p>
                ...
                <div class="col-lg-12">
					...
					<div class="text-center">
						<p style="color: #0f0f0f;;">Hello <?php if(isset($_SESSION['user'])){
 																echo $user['firstname'];}?>
                            <br>Manu Bookshop, a bonafide member of the India Booksellers Association, sells a variety of school supplies, including office equipment, books, lab equipment, sportswear, uniforms, computer accessories, exams, and printing services, to name a few. Our corporate headquarters are located in Delhi, India. Other branches are in Mumbai, Ghandhinagar shopping center. We are proud of our many satisfied clients in India's western region, which include public and private institutions, schools, and individuals. We are grateful for the opportunity to be a part of your educational journey.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer>
        <div class="footer text-center">
            <p style="color: black;"><b>&copy;<script>document.write(new Date().getFullYear());</script>  | <a style="color: white;" href="https://manubookshop.co.ke">Manu Bookshop</a>  |  All rights reserved</b></p>
        </div>
    </footer>
    <!-- Footer Section End -->
