		...
		foreach($stmt as $row){
			...
			try{
				$message = "
					<div style='text-align:center'>
							...
							<table>
								<tr>
									<td style='text-align:center'>
										<div>
											<a href='https://manubookshop.co.ke'>
											...
											<p style='color:black; font-family: Allura,cursive,Arial, Helvetica, sans-serif;  padding-top: 15px;'>
												'Hello ".$row['firstname'].", you have been a great customer for our business and on behalf of Manu Bookshop, I want to wish you a very happy new year 2024. May this year bring lots of hapiness in your life'
											</p>
										</div>
									</td>
								</tr>
									...
									<td>
										<div style='float:left;'>
											<p style='color:#b1190e;font-family: Arial, Helvetica, sans-serif; font-size:20px; text-align: center;'>
												'Be determined, there's blessings awaiting you,, 2024 comes with positive answers to your prayers,,, MANU BOOKSHOP wishes you a happy new year. </p>
												<br>
						...
						<div style='margin-left:150px; margin-right:150px; text-align: center;'>
							<p>You received this email because you signed up on our website <a href='https://manubookshop.co.ke'>www.manubookshop.co.ke</a> <br> &copy;<script>document.write(new Date().getFullYear());</script> <b> Manu Bookshop</b> Your Education Partner</p>
						</div>
					</div>
				";
				...
				try {
					...
					$mail->setFrom('manu@gmail.com', 'Uzo');
					
					//Recipients
					$mail->addAddress($email);              
					$mail->addReplyTo ('manu@gmail.com');
				   
					//Content
					$mail->isHTML(true);                                  
					$mail->Subject = 'Manu Bookshop Account Activation';
					$mail->Body    = $message;
