...
<head>
    ...
    <title>Manu Bookshop | Contact Us</title>
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><a href="mailto:manu@gmail.com"><i class="fa fa-envelope"></i> info@manubookshop.co.ke</a></li>
    ...
    <header class="header">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <h3 class="header-logo" style="padding-top:25px; color: black;"><b style="color:tomato;">Manu</b>Bookshop</h3>
                </div>
                <div class="col-lg-7">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                    <div class="contact__widget">
                        ...
                        <h4>Email</h4>
                        <p><a style="color: black;" href="mailto:info@manubookshop.co.ke">info@manubookshop.co.ke</a></p>
                    </div>
                </div>
            </div>
        </div>
