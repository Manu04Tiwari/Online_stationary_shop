...
<head>
  ...
  <title>Manu Bookshop | User Dashboard</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-success navbar-dark">
    ...
    <ul class="navbar-nav">
	  <li class="nav-item">
	  <span class="navbar-brand logo-mini" style="color: black;"><b style="color:tomato;">Manu</b>Bookshop</span>
      </li>
  ...
  <footer class="main-footer bg-success">
    <strong style="color:black;">Copyright &copy; 2021 <a href="https://manubookshop.co.ke"  style="color: white;">Manu Bookshop</a></strong>
