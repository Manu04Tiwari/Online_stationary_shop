...
<head>
    ...
    <meta name="keywords" content="Manu Bookshop">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Manu Bookshop | Categories</title>
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><a href="marttiwari8219@gmail.com"><i class="fa fa-envelope"></i> info@manubookshop.co.ke</a></li>
    ...
    <header class="header">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><a style="color: #ffffff;" href="mailto:marttiwari8219@gmail.com"><i class="fa fa-envelope"></i> info@Manubookshop.co.ke</a></li>
                                <li>Proud To Be Your Education Patner</li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <span class="header-logo navbar-brand logo-mini" style="padding-top:25px; color: black;"><b style="color:tomato;"></b>Manu Bookshop</span>
                </div>
                <div class="col-lg-7">
